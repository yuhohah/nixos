...
Item {
  ...
  function generate(requestedIface) {
    ...
    qrProc.command = requestedIface
      ? [root.omarchyPath ? (root.omarchyPath + "/bin/network-qr") : "network-qr", "--meta", requestedIface]
      : [root.omarchyPath ? (root.omarchyPath + "/bin/network-qr") : "network-qr", "--meta"]
    qrProc.running = true
  }
  ...
  function togglePassword() {
    ...
    pwProc.command = [root.omarchyPath ? (root.omarchyPath + "/bin/network-password") : "network-password", iface]
    pwProc.running = true
  }
